...
test:
	deno test --import-map=import_map.json --allow-env --no-check=remote --config deno.json src

test-watch:
	deno test --import-map=import_map.json --allow-env --no-check=remote --config deno.json --watch src
