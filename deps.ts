export * as crayon from "https://deno.land/x/crayon@3.1.0/mod.ts"; //needed to initialize crayon before using the chalk aliases
export { crayon as chalk} from "https://deno.land/x/crayon@3.1.0/src/extensions/chalk_aliases.ts";
