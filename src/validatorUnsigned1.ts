...
This validator does not sign items.  Anyone can modify these items.
Use this only for testing purposes or within a controlled environment.
...
export const ValidatorUnsigned1 : IValidator = class {
    static format : FormatName = 'unsigned.1';
    ...
    static itemSignatureIsValid(item: Item): boolean {
        return item.signature === 'unsigned';
    }
